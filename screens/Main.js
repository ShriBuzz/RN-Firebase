  ...
  return (
      <View style={styles.container}>          
        <View style={styles.headerContent}>
            ...
            <Text style={styles.name}>Shrijan Bajracharya</Text>
        ...
        <View style={styles.body}>
          <View>
              ...
              <Text style={styles.userInfo}>My Events</Text>
              

              <Text style={{color:'black', fontSize: 16, marginBottom: 20,}}>None</Text>
              <Text style={styles.userInfo}>Receive Notifications</Text>
